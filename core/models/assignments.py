...
class Assignment(db.Model):
    ...
    @classmethod
    def get_submitted_assignments_by_teacher(cls, teacher_id):
        return cls.filter(cls.teacher_id == teacher_id).filter(cls.state == AssignmentStateEnum.SUBMITTED)
    ...
    def grade_assignment(cls, _id, grade, principal: Principal):
        ...
        assertions.assert_valid(GradeEnum(grade) != None, 'invalid grade was provided')
