...
from core.apis.assignments import student_assignments_resources, teacher_assignments_resources, user_resources
...
app.register_blueprint(user_resources, url_prefix='/user')
